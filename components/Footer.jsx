      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-textColor2 uppercase">
                Quick Links
              </h2>
            ...
            <div>
              ...
              <ul className="text-textColor3">
                {clubInfo.address.map((line, index) => (
                  <li key={index} className="text-textColor3 mb-1">
                    {line}
                  </li>
                ))}
              </ul>
              ...
              <ul className="text-textColor3">
                <li className="mb-4">
                  <a
                    ...
                    className="text-textColor3 hover:underline flex flex-row min-w-max"
                  >
        ...
        <div className="sm:flex sm:items-center sm:justify-between ">
          <span className="text-sm text-textColor2 sm:text-center">
            © 2025 Iqlipse LPU. All Rights Reserved.
          </span>

          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href={clubInfo?.socials?.instagram || "#"} target="_blank">
              <svg
                className="w-5 h-5 hover:scale-150 scale-125 transition-all duration-200"
                fill="#dd2a7b"
                viewBox="0 0 24 24"
                aria-hidden="true"
              >
            ...
            <a href={clubInfo?.socials?.x || "#"} target="_blank">
              ...
              <svg
                className="w-5 h-5 hover:scale-150 scale-125 transition-all duration-200  dark:bg-white rounded"
                viewBox="0 0 50 50"
              >
            ...
            <a href={clubInfo?.socials?.linkedin || "#"} target="_blank">
              <img
                className="w-5 h-5 hover:scale-150 scale-125 transition-all duration-200  dark:fill-white"
